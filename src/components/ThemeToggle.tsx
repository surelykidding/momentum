    ...
    return (
      <>
        ...
        <button
          ...
          className="flex items-center space-x-2 px-4 py-2 rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 hover:bg-white dark:hover:bg-gray-800 transition-all duration-300 hover:scale-105 shadow-sm hover:shadow-md focus-ring"
          aria-label="选择主题"
        ...
        >
          ...
          {showLabel && (
            <span className="text-sm font-medium text-gray-700 dark:text-gray-200 font-chinese">
              {currentTheme?.label}
            </span>
          )}
          <svg
        ...
        {isDropdownOpen && (
          <>
            ...
            {/* Dropdown menu */}
            <div className="absolute right-0 top-full mt-2 w-64 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 backdrop-blur-sm z-20 animate-scale-in">
              <div className="p-2">
                <div className="px-3 py-2 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider font-chinese">
                  主题设置
                </div>
